...
public class Lista1Ex01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("As porcentagens sao: 7.5, 9, 12, e 14 porcento");
		inss = sc.nextInt();

		salarioBruto = salarioHora * horasTrabalhadas;
		System.out.printf("O valor do salario bruto eh R$:%.2f  %n", salarioBruto);

		if (inss == 7.5) {
			salarioLiquido = salarioBruto * 0.925;
			System.out.printf("O valor do salario liquido eh R$:%.2f %n", salarioLiquido);
		} 
		else if (inss == 9) {
