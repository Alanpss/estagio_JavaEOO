...
public class Lista1Ex04 {
	...
	public static void main(String[] args) {
		...
		if (nota1 > nota2 && nota1 > nota3) {
			System.out.printf("A maior nota eh a Primeira que foi: %.2f", nota1);
		} else if (nota2 > nota1 && nota2 > nota3) {
			System.out.printf("A mair nota eh a Segunda que foi:  %.2f", nota2);
		} else if (nota3 > nota1 && nota3 > nota2) {
			System.out.printf("A maior nota eh a Terceira que foi: %.2f", nota3);
		}
