...
public class Lista1Ex16 {
	...
	public static void main(String[] args) {
		...
		// Saidas de dados
		System.out.printf("A media de idade dos homens � de: %d anos", (int) mediaIdadeHomens);
		System.out.println();
		System.out.printf("A soma das idades das Mulheres � igual a: %d", (int) somaIdadeMulheres);
		System.out.println();
